...
function createPopup(dataset){
  ...
  var l_country = document.createElement("label");

  var lables = [l_nic, l_mail, l_name, l_phone, l_joined_date, l_description, l_country];
  ...
  var data = [p_nic, p_mail, p_name, p_phone, p_joined_date, p_description, p_country];
  ...
  //create body
  var label_list = ["NIC/Passport/Driving licence", "Email", "Name", "Contact no", "Joined Date", "Description", "Country"];
  ...
  p_country.innerHTML = dataset.country;
